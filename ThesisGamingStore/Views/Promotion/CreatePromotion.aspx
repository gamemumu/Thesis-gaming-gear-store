...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="page-header">สร้างโปรโมชั่น</h3>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="panel panel-primary">
                <div class="panel-heading">สินค้าที่จะจัดโปรโมชั่น</div>
                <div class="panel-body">
        ...
        function btnSendData() {
            ...
            if (Date.parse(startDate) < Date.parse(finDate)) {
                if (($("#ProMStartDate").val() != "") && ($("#ProMEndDate").val()) != "" && listPro.length > 0) {
                    var MultiOjb = [];
                    var rows = [];
                    var head = []; d_head = { ProMStartDate: $("#ProMStartDate").val(), ProMEndDate: $("#ProMEndDate").val(), Discount: $("#Discount").val() };
                    head.push(d_head)
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<%= Url.Action("CreatePromotion","Promotion")%>",
                        dataType: "json",
