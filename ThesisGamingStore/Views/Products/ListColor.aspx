<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterGaming.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<ThesisGamingStore.Models.ColorModel>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="page-header">รายการสีสินค้า</h3>
 <p>
          <h4><%: Html.ActionLink("สร้างสีใหม่","ColorCreate") %></h4>
    </p>
 <table id="tbl_List" class="table table-condensed table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>
                <%: Html.DisplayName("ColorID") %>
            </th>
            <th>
...
<tbody>
    <% foreach (var item in Model)
        ...
        <tr>
            <td>
                <%: Html.DisplayFor(modelItem => item.ClrID) %>
            </td>
            <td>
            ...
            <td>
                <%: Html.ActionLink("Edit", "EditColor", new {ClrID = item.ClrID/* id=item.PrimaryKey */ }) %> |
            <%: Html.ActionLink("Delete", "DeleteColor", new { ClrID = item.ClrID/* id=item.PrimaryKey */ }) %>
            </td>
        </tr>
        <% } %>
